...
{
	[SuppressMessage("ReSharper", "UnusedType.Global", Justification = "Required SSO Settings.")]
	public class SsoSettings : EnvironmentSettings<SsoSettings>, IEnvironmentSettings
	{
